    ...
    static void SetLayoutParametersForView(in View snackbarView)
    {
        ...
        //if (snackbarView.Context?.Resources is not null)
        {
            ...
            if (layoutParameters is not null)
            {
                ...
                //var navigationBarHeight = ApplicationEx.GetNavigationBarHeight();
                //snackbarView.TranslationY = -(navigationBarHeight + 32f);
                //snackbarView.TranslationZ = 32f;
                //snackbarView.SetPadding(16, 0, 16, 0);
            }
        }
    }
